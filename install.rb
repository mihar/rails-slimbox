...
FileUtils.mkdir_p File.dirname(__FILE__) + '/../../../public/images/slimbox'
FileUtils.mkdir_p File.dirname(__FILE__) + '/../../../public/javascripts/lib'
FileUtils.mkdir_p File.dirname(__FILE__) + '/../../../public/stylesheets/lib'
